...
public class Transporte {
    ...
    public void setIdTransporte(int idTransporte) {
      ...
      if (!Validator.validarId(idTransporte)) {

          throw new IllegalArgumentException(
                  "El identificador del transporte debe ser mayor que cero.");
    ...
    if (!Validator.noEsVacio(tipoVehiculo)){

        throw new IllegalArgumentException(
                "El tipo de vehículo no puede estar vacío.");

        } else if (!Validator.longitudMinima(tipoVehiculo, 3)){

            throw new IllegalArgumentException(
                    "El tipo de vehículo debe tener al menos 3 caracteres.");
